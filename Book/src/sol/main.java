	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			if (ans.equals("2")) {
				...
				System.out.println("과거 구매내역을 조회하겠습니까?\n(1.예 2.아니요)");
				String ans0 = sc.nextLine();
				if (ans0.equals("1")) {
					String path = "C:\\Users\\yessh\\git\\book_project\\Book\\src\\vo\\";
					String hbook = "bookHistory.txt";
					try {
						FileReader fin = new FileReader(path + hbook);
